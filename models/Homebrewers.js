...
Homebrewer.add(
	...
	profileBrief: { type: Types.Html, wysiwyg: true, required: false, "default": "Read more..." },
	profileBody: { type: Types.Html, wysiwyg: true, required: false },
	profileVideo: { type: Types.Url, required: false },
	//beerList: { type: Types.Relationship, ref: 'Beers', index: true },
	brewerAwards: { type: Types.Html, wysiwyg: true},
	featuredBeerType: { type: String },
	featuredBeerName: { type: String },
	featuredBeerPictureURL: { type: Types.Url },
	featuredBeerProfileURL: { type: Types.Url },
	featuredBeerShortDescription: { type: String },
	featuredBeerFullDescription: { type: Types.Html, wysiwyg: true},
