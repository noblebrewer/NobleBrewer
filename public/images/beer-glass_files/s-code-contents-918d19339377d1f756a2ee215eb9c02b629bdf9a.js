s_assets = new AppMeasurement()

/************************** CONFIG SECTION **************************/
/* You may add or alter any code config here. */

s_assets.charSet="ISO-8859-1"
/* Conversion Config */
s_assets.currencyCode="USD"
/* Link Tracking Config */
s_assets.trackDownloadLinks=true
s_assets.trackExternalLinks=true
s_assets.trackInlineStats=false
s_assets.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx"
s_assets.linkInternalFilters="javascript:,assets.adobe.com,adobecc.com"
s_assets.linkLeaveQueryString=false
s_assets.linkTrackVars="None"
s_assets.linkTrackEvents="None"
s_assets.trackOffline=true;




/* Plugin Config */
s_assets.usePlugins=true
function s_doPlugins(s_assets) {
  /* Time Parting */	

var timeVar = s_assets.getTimeParting('n','-7');
...
s_assets.eVar5 = dayOfWeek;
s_assets.eVar6 = hourOfDay;
  
  }
s_assets.doPlugins=s_doPlugins
 ...
 * Plugin: getTimeParting 3.4
 */
s_assets.getTimeParting=new Function("h","z",""
 ...
 */
s_assets.apl=new Function("l","v","d","u",""
 ...
 */
s_assets.pt=new Function("x","d","f","a",""
...
/*
		...
		*/
		s_assets.split=new Function("l","d",""
 ...
 */
s_assets.manageVars=new Function("c","l","f",""
...
+"}s_assets.pt(vl,',',c,0);return true;}else if(l==''&&f==1){s_assets.pt(vl,',',c,0"
+");return true;}else{return false;}");
s_assets.clearVars=new Function("t","var s=this;s[t]='';");
s_assets.lowercaseVars=new Function("t",""
...
s_assets.visitorNamespace="adobemobiledev";
s_assets.trackingServer="stats.adobe.com";
s_assets.trackingServerSecure="sstats.adobe.com";
/*
