...
(function(window) {
  ...
  var _swfPath = function() {
    ...
    if (document.currentScript && (jsPath = document.currentScript.src)) {} else {
      ...
      // IE and Safari do not have document.currentScript, so we have to manually find the ZeroClipboard.js in the source list.
      if (jsPath === undefined) {
        for (i = scripts.length; i--; ) {
          if (scripts[i].src.search("ZeroClipboard") !== -1) {
  ...
  _globalConfig.moviePath = _swfPath; //"ZeroClipboard.swf";
